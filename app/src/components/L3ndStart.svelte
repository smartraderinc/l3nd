<script lang="ts">
    ...
    async function connectWallet() {
        try {
            ...
            if (chainId) {
                window.location.href = "/lend?address="+ myAccount;
                }
...
<!-- {#if !myAccount} -->
    <button class="btn wallet-connect" on:click={connectWallet} style=""><p class="black-button-text">Connect Wallet</p></button>
<!-- {/if} -->
